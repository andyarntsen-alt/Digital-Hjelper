  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <div className="mt-12 card bg-blue-50">
        <h2 className="text-2xl font-bold mb-4">{t('whoCanGetSupportTitle')}</h2>
        <div className="space-y-4">
          <div className="bg-white p-4 rounded-lg">
            <p className="font-semibold text-gray-800">{t('studielanInfoTitle')}</p>
            <p className="text-gray-600">{t('studielanInfoDesc')}</p>
          </div>
          <div className="bg-white p-4 rounded-lg">
            <p className="font-semibold text-gray-800">{t('stipendInfoTitle')}</p>
            <p className="text-gray-600">{t('stipendInfoDesc')}</p>
          </div>
          <div className="bg-white p-4 rounded-lg">
            <p className="font-semibold text-gray-800">{t('utsettelsInfoTitle')}</p>
            <p className="text-gray-600">{t('utsettelsInfoDesc')}</p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 card bg-gray-50">
        ...
        <ul className="space-y-3 text-lg">
          <li className="flex items-center gap-3">
            ...
            <span><strong>{t('linkLanekassen')}</strong> - {t('linkLanekassenDesc')}</span>
          </li>
          <li className="flex items-center gap-3">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
            </svg>
            <span><strong>{t('linkSamordna')}</strong> - {t('linkSamordnaDesc')}</span>
          </li>
          <li className="flex items-center gap-3">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
