...
export default function TilbakebetalingPage() {
  ...
  const optionsRaw = t.raw('options') as string[];
  const tipsRaw = t.raw('tips') as string[];

  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <Link href="/utdanning" className="text-indigo-600 hover:underline mb-6 inline-flex items-center gap-2">
      ...
      <div className="card bg-green-50 mb-8">
        <h2 className="text-xl font-bold mb-4 text-green-800">{t('optionsTitle')}</h2>
