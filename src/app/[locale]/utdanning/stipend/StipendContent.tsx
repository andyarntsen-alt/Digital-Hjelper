...
export default function StipendContent() {
  const t = useTranslations('guides.utdanning.stipend');
  ...
  return (
    <GuideLayout
      guideId="utdanning-stipend"
      translationNamespace="guides.utdanning.stipend"
