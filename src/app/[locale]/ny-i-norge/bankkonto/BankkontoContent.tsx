...
export default function BankkontoContent() {
  const t = useTranslations('guides.nyINorge.bankkonto');
  ...
  const banksRaw = t.raw('banks') as { name: string; description: string }[];
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 sm:py-8 md:py-12">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            ...
            <PrintButton />
            <ShareButton />
            <FavoriteButton guideId="ny-i-norge-bankkonto" title={t('title')} />
          </div>
          </div>
          <p className="text-xl text-gray-600 mt-3">{t('longDescription')}</p>
        </div>

        <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 mb-8">
          <h2 className="text-xl font-bold mb-4 text-gray-900">{t('requirementsTitle')}</h2>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 mb-8">
          <h2 className="text-xl font-bold mb-4 text-gray-900">{t('banksTitle')}</h2>
          <div className="space-y-4">
            {banksRaw.map((bank, index) => (
