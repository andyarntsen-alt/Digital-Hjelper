...
export default function BankkontoContent() {
  ...
  return (
    <GuideLayout
      guideId="ny-i-norge-bankkonto"
      translationNamespace="guides.nyINorge.bankkonto"
    ...
    >
      ...
      <CollapsibleSection title={t('requirementsTitle')} className="mb-4">
      ...
      {/* Collapsible: Banks */}
      <CollapsibleSection title={t('banksTitle')} className="mb-6">
