  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          ...
          <div className="prose max-w-none mb-6">
            <p className="text-lg text-gray-700 leading-relaxed">
              <strong>Helsenorge</strong> er den offentlige helseportalen i Norge hvor du kan administrere din helse digitalt.
        ...
        <div className="mt-12">
          <h2 className="text-2xl font-bold mb-6">❓ Vanlige spørsmål om Helsenorge</h2>
              ...
              <details key={index} className="card group">
                <summary className="cursor-pointer list-none flex justify-between items-center">
                  ...
                  <svg
                    ...
                    className="h-5 w-5 text-helse-red transform transition-transform group-open:rotate-180 flex-shrink-0"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            <Link href="/nav" className="flex items-center gap-3 p-3 bg-white rounded-lg hover:shadow-md transition-shadow">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Dagpenger, sykepenger, meldekort</p>
              </div>
            </Link>
