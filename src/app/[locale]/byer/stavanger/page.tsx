    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 sm:py-16">
        ...
        <section className="mb-16">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">{t('navOfficesIn', { city: t('stavanger.name') })}</h2>
        ...
        {/* Helsetjenester */}
        <section className="mb-16">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">{t('healthServicesIn', { city: t('stavanger.name') })}</h2>

          <div className="grid sm:grid-cols-2 gap-4">
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-5">
              <h3 className="font-bold text-gray-900 mb-2">{t('emergencyRoomIn', { city: t('stavanger.name') })}</h3>
              <p className="text-gray-700 text-sm">{t('stavanger.emergencyAddress')}</p>
        ...
        {/* Nyttige lenker */}
        <section className="mb-16">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">{t('usefulLinksFor', { city: t('stavanger.name') })}</h2>
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            <a href="https://www.stavanger.kommune.no" target="_blank" rel="noopener noreferrer"
              ...
              <p className="font-medium text-gray-900">{t('municipality', { city: t('stavanger.name') })}</p>
              <p className="text-sm text-gray-500">stavanger.kommune.no</p>
            </a>
            <a href="https://www.kolumbus.no" target="_blank" rel="noopener noreferrer"
              ...
              <p className="font-medium text-gray-900">Kolumbus</p>
        ...
        {/* FAQ */}
        <section className="mb-16">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">{t('faqAbout', { city: t('stavanger.name') })}</h2>
