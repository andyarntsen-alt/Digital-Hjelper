  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 sm:py-16">
        ...
        <div className="mb-12">
          <Link href="/" className="text-gray-500 hover:text-skatt-green no-underline mb-6 inline-flex items-center gap-2 text-sm font-medium">
          ...
          <div className="flex items-start gap-4 mb-8">
            <div className="bg-skatt-green text-white p-3 rounded-xl flex-shrink-0">
            ...
            <Link key={index} href={guide.href} className="no-underline group">
              <div className="bg-white border border-gray-200 rounded-xl p-5 h-full hover:border-gray-300 hover:bg-gray-50 transition-colors">
                <div className="flex justify-between items-start mb-3">
                  <h3 className="text-lg font-semibold text-gray-900 group-hover:text-skatt-green transition-colors">{tGuides(`${guide.key}.title`)}</h3>
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="text-skatt-green font-medium flex items-center gap-1">
                    {tCommon('startGuide')}
        ...
        <div className="mt-16">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-4 p-4 bg-white border border-gray-200 rounded-xl">
              ...
              <div>
                <p className="font-medium text-gray-900">{t('datesMarchTitle')}</p>
                <p className="text-sm text-gray-600">{t('datesMarchDesc')}</p>
              </div>
            </div>
            <div className="flex items-center gap-4 p-4 bg-white border border-gray-200 rounded-xl">
              <div className="bg-skatt-green text-white px-3 py-1.5 rounded-lg text-sm font-bold flex-shrink-0">
              ...
              <div>
                <p className="font-medium text-gray-900">{t('datesAprilTitle')}</p>
                <p className="text-sm text-gray-600">{t('datesAprilDesc')}</p>
              </div>
            </div>
            <div className="flex items-center gap-4 p-4 bg-white border border-gray-200 rounded-xl">
              <div className="bg-skatt-green text-white px-3 py-1.5 rounded-lg text-sm font-bold flex-shrink-0">
              ...
              <div>
                <p className="font-medium text-gray-900">{t('datesJuneTitle')}</p>
                <p className="text-sm text-gray-600">{t('datesJuneDesc')}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 bg-gray-50 border border-gray-200 rounded-xl p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 text-gray-700">
              ...
              <span><strong className="text-gray-900">{t('phone')}:</strong> {t('phoneNumber')} ({t('phoneHours')})</span>
            </div>
            <div className="flex items-center gap-3 text-gray-700">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
