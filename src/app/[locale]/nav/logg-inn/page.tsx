    ...
    <>
      ...
      <div className="warning-box mb-8">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="font-semibold text-yellow-800">{t('beforeYouStart')}</p>
            <p className="text-yellow-700">
              {t('beforeYouStartText')}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 card bg-blue-50">
        <h2 className="text-xl font-bold mb-3">{t('problemsTitle')}</h2>
        ...
        <ul className="space-y-2 text-gray-700">
          {problemsList.map((problem, index) => (
            <li key={index} className="flex items-start gap-2">
              <span className="text-nav-blue">•</span>
              <span>{problem}</span>
            </li>
          ))}
        </ul>
