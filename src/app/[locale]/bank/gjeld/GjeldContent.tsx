  ...
  return (
    <>
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <PrintButton />
            <ShareButton />
            <FavoriteButton guideId="bank-gjeld" title={t('title')} />
          </div>
        </div>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 mb-8">
        <h2 className="text-xl font-bold mb-4 text-gray-900">{t('importantTitle')}</h2>
        <p className="text-gray-700">{t('importantText')}</p>
      </div>

      <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 mb-8">
        <h2 className="text-xl font-bold mb-4 text-gray-900">{t('signsTitle')}</h2>
