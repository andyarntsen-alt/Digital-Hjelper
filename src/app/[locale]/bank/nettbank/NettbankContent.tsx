...
export default function NettbankPage() {
  ...
  const beforeYouStartRaw = t.raw('beforeYouStartItems') as string[];
  const securityTipsRaw = t.raw('securityTips') as string[];
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <PrintButton />
            <ShareButton />
            <FavoriteButton guideId="bank-nettbank" title={t('title')} />
          </div>
        </div>
