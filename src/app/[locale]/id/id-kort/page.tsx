...
export default function IdKortPage() {
  ...
  const typesRaw = t.raw('types') as string[];
  const tipsRaw = t.raw('tips') as string[];

  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <Link href="/id" className="text-cyan-600 hover:underline mb-6 inline-flex items-center gap-2">
      ...
      <div className="card bg-purple-50 mb-8">
        <h2 className="text-xl font-bold mb-4 text-purple-800">{t('typesTitle')}</h2>
        <ul className="space-y-2">
          {typesRaw.map((type, index) => (
