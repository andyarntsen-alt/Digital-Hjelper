  ...
  return (
    <nav aria-label={t('aria.breadcrumb')} className="mb-6 print:hidden">
      <ol className="flex flex-wrap items-baseline gap-2 text-sm text-gray-600">
        <li>
          <Link href="/" className="hover:text-nav-blue no-underline inline-flex items-center gap-1">
        ...
        {items.map((item, index) => (
          <li key={index}>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gray-400 mx-1 inline align-middle" fill="none" viewBox="0 0 24 24" stroke="currentColor">
