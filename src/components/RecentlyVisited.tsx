      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex gap-3 overflow-x-auto pb-2 -mx-4 px-4 sm:mx-0 sm:px-0 sm:flex-wrap">
          {recentGuides.map((guide) => (
            <div
              key={guide.href}
              className="flex-shrink-0 relative group bg-white border-2 border-gray-200 rounded-lg hover:border-nav-blue active:border-nav-blue transition-all duration-200 min-w-[160px] sm:min-w-0 sm:flex-1 sm:max-w-[250px]"
            >
              <Link
                href={guide.href}
